...
final class Version20190908121528 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE has_status DROP INDEX UNIQ_57227287CB944F1A, ADD INDEX IDX_57227287CB944F1A (student_id)');
        $this->addSql('ALTER TABLE has_status DROP INDEX UNIQ_57227287A40A2C8, ADD INDEX IDX_57227287A40A2C8 (calendar_id)');
        ...
        $this->addSql('ALTER TABLE has_status DROP classroom_id');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE has_status DROP INDEX IDX_57227287A40A2C8, ADD UNIQUE INDEX UNIQ_57227287A40A2C8 (calendar_id)');
        $this->addSql('ALTER TABLE has_status DROP INDEX IDX_57227287CB944F1A, ADD UNIQUE INDEX UNIQ_57227287CB944F1A (student_id)');
        $this->addSql('ALTER TABLE has_status ADD classroom_id INT DEFAULT NULL');
