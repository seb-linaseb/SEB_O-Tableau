...
final class Version20190905135934 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE document_student (document_id INT NOT NULL, student_id INT NOT NULL, INDEX IDX_134C09EFC33F7837 (document_id), INDEX IDX_134C09EFCB944F1A (student_id), PRIMARY KEY(document_id, student_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE student_lunch_type (student_id INT NOT NULL, lunch_type_id INT NOT NULL, INDEX IDX_F3FB5E1ACB944F1A (student_id), INDEX IDX_F3FB5E1A2C3B40B5 (lunch_type_id), PRIMARY KEY(student_id, lunch_type_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
